		    ...
		    if(isset($_POST['submit']))
		    {
		    	...
		    	if(isset($_FILES['image']['name']))
		    	{
		    		...
		    		if($image_name!="")
		    		{
		    			...
		    			$src_path = $_FILES['iamge']['tmp_name']; //source path
		    	...
		    	if($res3==true)
		    	{
		    		...
		    		$_SERVER['update'] = "<div class='success'>Food Updated Successfully</div>";
		    		header('location:'.SITEURL.'admin/manage-food.php');
		    	}
		    	else
		    	{
		    		//failed to update food
		    		$_SERVER['update'] = "<div class='error'>Failed to Update Food</div>";
		    		header('location:'.SITEURL.'admin/manage-food.php');
		    	}
